...
use crate::allocator::{AllocationReport, fmt_bytes};

#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub enum AllocationReportVisualizeSorting {
    #[default]
    None,
    Idx,
    Name,
...
pub struct AllocationReportVisualizeSettings {
    pub filter: String,
    pub sorting: AllocationReportVisualizeSorting,
    pub ascending: bool,
}

pub fn render_allocation_reports_ui(
    ui: &mut Ui,
